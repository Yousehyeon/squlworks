...
-- 이름 변경
ALTER TABLE book RENAME COLUNM price TO saleprice;
--자료형 변경
...
INSERT INTO book VALUES (2, '축구아는 역사', '나무수', 13000);
...
--가격이 10000원 이상 20000원 이하인 도서를 검색하시오(BETWEEN)
SELECT *
FROM book
WHERE price
